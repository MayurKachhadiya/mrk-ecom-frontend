...
const AddReview = ({ openDialog, closeDialog, handleEdit, onSuccess }) => {
  const { pid } = useParams();
  ...
  const handleSubmit = methods.handleSubmit(({ productComment }) => {
    ...
    axios
      .post(
        "https://mrk-ecom-backend.onrender.com/review/add",
        {
          rating: newRatingVal,
  ...
  const handleUpdate = methods.handleSubmit(({ productComment }) => {
    ...
    axios
      .post(
        `https://mrk-ecom-backend.onrender.com/review/update/${handleEdit._id}`,
        {
          rating: newRatingVal,
          comment: productComment,
          reviewDate: currentDate.toDateString(),
